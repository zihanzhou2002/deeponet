...
class DeepONetComplex(NN):
    ...
    def build_branch_net(self, layer_sizes_branch):
        ...
        return FNN(layer_sizes_branch, self.activation_branch, self.kernel_initializer, dtype=torch.complex64)

    def build_trunk_net(self, layer_sizes_trunk):
        return FNN(layer_sizes_trunk, self.activation_trunk, self.kernel_initializer, dtype=torch.complex64)
...
class DeepONetCartesianProdComplex(NN):
